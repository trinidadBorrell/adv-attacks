...
def _process_single_attack(
    args: tuple[str, int, str, str, float, int, Path, str],
...
def _process_image_all_combinations(
    args: tuple[str, int, str, str, list, list, Path, str],
...
def run_batch_attacks(
    ...
    targeted_coarse_classes_1: list[str],
    targeted_coarse_classes_2: list[str],
    epsilons: list[float],
    test_types: list[int],
    ...
    for i, image_path in enumerate(image_paths):
        unique_image_tasks.append(
            (
                image_path,
                fine_class_ids[i],
                targeted_coarse_classes_1[i],
                targeted_coarse_classes_2[i],
                epsilons,
                test_types,
                output_base_dir,
                device,
                    ...
                    results_summary["successful_results"].append(
                        {
                            ...
                            "targeted_coarse_class_1": metadata[
                                "targeted_coarse_class_1"
                            ],
                            "targeted_coarse_class_2": metadata[
                                "targeted_coarse_class_2"
                            ],
